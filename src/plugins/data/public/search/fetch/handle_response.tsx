...
// OpenSearch error types that indicate user query syntax problems rather than infrastructure issues
...
export function showInvalidQueryToast() {
  ...
  try {
    ...
    // If the toast itself fails (e.g. i18n / toMountPoint not ready), reset the guard
    _invalidQueryToastVisible = false;
  }
}
